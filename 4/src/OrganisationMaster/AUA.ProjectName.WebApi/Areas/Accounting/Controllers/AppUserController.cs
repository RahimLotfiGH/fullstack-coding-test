...
namespace AUA.ProjectName.WebApi.Areas.Accounting.Controllers
{
    ...
    public class AppUserController : BaseApiController
    {
        ...
        [HttpGet]
        [WebApiAuthorize(EUserAccess.Profile)]
        public async Task<ResultModel<AppUserDto>> GetCurrentUserAsync()
        {
            var result = await _appUserService.GetDtoByIdAsync(UserId);
        ...
        public async Task<ResultModel<bool>> CurrentUserUpdateAsync(AppUserUpdateVm appUserDto)
        {
            appUserDto.Id = UserId;

            var result = await _appUserService
                .UpdateCustomVmAsync(appUserDto);
