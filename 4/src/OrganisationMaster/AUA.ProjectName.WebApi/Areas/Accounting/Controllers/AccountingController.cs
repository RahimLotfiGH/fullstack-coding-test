...
using AUA.ProjectName.WebAPi.Utility.Security;
...
namespace AUA.ProjectName.WebApi.Areas.Accounting.Controllers
{
    public class AccountingController : BaseApiController
    {
        ...
        public AccountingController(ILoginVmValidationService loginVmValidationService
        ...
        {
            var message = CreateLogMessage(loginDm.ResultStatus.ToDescription(),
